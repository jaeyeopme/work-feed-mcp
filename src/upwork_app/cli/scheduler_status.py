...
from upwork_app.services.scheduler_status import SchedulerStatusError, scheduler_status
...
def build_parser() -> argparse.ArgumentParser:
    parser = SchedulerStatusArgumentParser(prog="upwork-app scheduler-status")
