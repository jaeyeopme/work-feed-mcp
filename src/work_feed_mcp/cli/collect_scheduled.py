...
from work_feed_mcp.core.errors import exit_code_for_error as ingest_exit_code
...
def build_parser() -> argparse.ArgumentParser:
    parser = ScheduledCollectionArgumentParser(prog="work-feed collect-scheduled")
